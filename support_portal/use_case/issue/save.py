...
def update(issue, method):
    ...
    if issue.support_terms:
        ...
        if support_term.cantidad_total:
            support_term.cantidad_restante = support_term.cantidad_total - support_term.cantidad_facturada
        else:
            support_term.cantidad_restante = support_term.cantidad_facturada
